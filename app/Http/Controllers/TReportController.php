...
class TReportController extends Controller
{
    ...
    public function indexR(){
        ...
        $pounit = DB::SELECT('SELECT * FROM unit_pull_outs WHERE POUStatus="" AND POUTransferArea="" AND POUTransferBay="" AND POUBrand=1');
        ...
        return view('workshop-ms.t-workshop.report',compact('brand','section','technician','bay','pounit','cunit', 'workshop'));
    }
