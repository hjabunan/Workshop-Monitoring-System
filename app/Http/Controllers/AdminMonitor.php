...
class AdminMonitor extends Controller
{
    public function index(){
        ...
        return view('workshop-ms.admin_monitoring.index',compact('bays', 'baysT', 'sectionT', 'workshop','part','CUnitTICJ','CUnitTEJ','CUnitTICC','CUnitTEC','CUnitTRT','CUnitBTRT','CUnitBTS','CUnitRTR','CUnitRS','CUnitST','CUnitPPT','CUnitOPC','CUnitHPT','CUnitTotal'));
    }
