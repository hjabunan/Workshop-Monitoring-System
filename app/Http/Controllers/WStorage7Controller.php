...
class WStorage7Controller extends Controller
{
    public function index(){
        ...
        return view('workshop-ms.w-storage7.index',compact('bays', 'workshop', 'scl', 'sectionT','baysT','CUnitTICJ','CUnitTEJ','CUnitTICC','CUnitTEC','CUnitTRT','CUnitBTRT','CUnitBTS','CUnitRTR','CUnitRS','CUnitST','CUnitPPT','CUnitOPC','CUnitHPT','CUnitTotal'));
    }
