...
class RReportController extends Controller
{
    ...
    public function indexR(){
        ...
        return view('workshop-ms.r-workshop.report',compact('brand','section','technician','bay','bnunit','pounit','cunit', 'workshop'));
    }
    ...
    public function sortPullOut(Request $request){
        ...
        if($UStatus == 'pouRadioPOU'){
            $pounit = DB::SELECT('SELECT * FROM unit_pull_outs WHERE POUStatus="" AND POUBrand=3');
        }else if($UStatus == 'pouRadioCU'){
            $pounit = DB::SELECT('SELECT * FROM unit_pull_outs WHERE POUStatus=2 AND POUBrand=3');
        }else if($UStatus == 'pouRadioDU'){
            $pounit = DB::SELECT('SELECT * FROM unit_pull_outs WHERE POUStatus=3 AND POUBrand=3');
        }else{
            $pounit = DB::SELECT('SELECT * FROM unit_pull_outs WHERE POUBrand=3');
        }
