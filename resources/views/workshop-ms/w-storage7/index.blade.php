        ...
        $(document).ready(function(){
            ...
            // Get Data per Bay
                jQuery(document).on( "click", ".btnBay", function(){
                    ...
                    $.ajax({
                        url: "{{ route('w-storage7.getBayData') }}",
                        type: "GET",
                        dataType: "json",
            ...
            // Get Transfer Data
                jQuery(document).on( "click", "#transferUnit", function(){
                    ...
                    $.ajax({
                        url: "{{ route('w-storage7.getTransferData') }}",
                        type: "GET",
                        dataType: "JSON",
            ...
            // Save Transfer Data
                jQuery(document).on( "click", "#saveTransferUnit", function(){ 
                    // alert($('#BayID').val());
                    $.ajax({
                        url: "{{ route('w-storage7.saveTransferData') }}",
                        type: "POST",
                        // dataType: "JSON",
            ...
            // Save Unit Data
                jQuery(document).on( "click", "#saveUnit", function(){
                    var _token = $('input[name="_token"]').val();
                    $.ajax({    
                        url: "{{ route('w-storage7.saveUnitData') }}",
                        type: "POST",
