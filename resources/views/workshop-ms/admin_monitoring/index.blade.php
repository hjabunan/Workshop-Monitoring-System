                            ...
                            <div class="mb-4 border-b border-gray-200">
                                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                                    <li class="" role="presentation">
                                        <button class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="BTArea-tab" data-tabs-target="#BTArea" type="button" role="tab" aria-controls="BTArea" aria-selected="false">BT AREA</button>
                                    </li>
                                    <li class="" role="presentation">
                                        <button class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="ToyotaArea-tab" data-tabs-target="#ToyotaArea" type="button" role="tab" aria-controls="ToyotaArea" aria-selected="false">TOYOTA AREA</button>
                                    </li>
                                    <li class="" role="presentation">
                                        <button class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="RaymondArea-tab" data-tabs-target="#RaymondArea" type="button" role="tab" aria-controls="RaymondArea" aria-selected="false">RAYMOND AREA</button>
                                    </li>
                                </ul>
                            </div>

                            <div id="myTabContent">
                                <div class="hidden p-1.5 rounded-lg" id="BTArea" role="tabpanel" aria-labelledby="BTArea-tab">
                                    <div class="">
                                ...
                                <div class="hidden p-1.5 rounded-lg" id="ToyotaArea" role="tabpanel" aria-labelledby="ToyotaArea-tab">
                                    <div class="">
                                        <div class="grid grid-cols-4 content-start gap-2 mr-2">
                                            @foreach ($bays as $bay)
                                                @if ($bay->section == 1)
                                ...
                                <div class="hidden p-1.5 rounded-lg" id="RaymondArea" role="tabpanel" aria-labelledby="RaymondArea-tab">
                                    <div class="">
                                        <div class="grid grid-cols-4 content-start gap-2 mr-2">
                                            @foreach ($bays as $bay)
                                                @if ($bay->section == 3)
