        ...
        $(document).ready(function () {
            ...
            // Saving of Pull Out Unit
                $('#savePullOut').on( "click", function(){
                    ...
                    if($('#POUUnitType').val() == 1){
                        if ($('#POUBrand').val() == '' || $('#POUUnitType2').val() == '' || $('#POUClassification').val() == '' || $('#POUModel').val() == '' || $('#POUSerialNum').val() == '' || $('#POUCode').val() == '' || $('#POUMastType').val() == '' || $('#POUMastHeight').val() == '' || $('#POUForkSize').val() == '' || $('#POUTechnician1').val() == '' || $('#POURemarks').val() == '' ){
                        ...
                        if ($('#POUBrand').val() == '' || $('#POUUnitType2').val() == '' || $('#POUClassification').val() == '' || $('#POUModel').val() == '' || $('#POUSerialNum').val() == '' || $('#POUCode').val() == '' || $('#POUMastType').val() == '' || $('#POUMastHeight').val() == '' || $('#POUForkSize').val() == '' || $('#POUTechnician1').val() == '' || $('#POUBABrand').val() == '' || $('#POUBABatType').val() == '' || $('#POUBASerialNum').val() == '' || $('#POUBACode').val() == '' || $('#POUBAAmper').val() == '' || $('#POUBAVolt').val() == '' || $('#POUCBrand').val() == '' || $('#POUCModel').val() == '' || $('#POUCSerialNum').val() == '' || $('#POUCCode').val() == '' || $('#POUCAmper').val() == '' || $('#POUCVolt').val() == '' || $('#POUCInput').val() == '' || $('#POURemarks').val() == '' ){
                            $("#failed-modal").removeClass("hidden");
                            $("#failed-modal").addClass("flex");
                            $('#savePullOut').prop("disabled", false);
                        } else {
                ...
                $('#savePullOutH').on( "click", function(){
                    $.ajax({
                        url: "{{ route('ppt-workshop.report.savePullOut') }}",
                        type: "POST",
            ...
            // View POU
                jQuery(document).on( "click", ".btnPOUView", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ppt-workshop.report.getPOUData') }}",
                        method:"GET",
                        dataType: 'json',
            ...
            // Delete POU
                ...
                jQuery(document).on( "click", "#deleteConfirmPOU", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ppt-workshop.report.deletePOU') }}",
                        method:"POST",
            ...
            // If Area Change, Data from Bay also changes
                jQuery(document).on( "change", "#POUArea", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ppt-workshop.report.getBay') }}",
                        method:"GET",
            ...
            // Transfer POU
                jQuery(document).on( "click", "#transferPOU", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ppt-workshop.report.transferPullOut') }}",
                        method:"POST",
            ...
            // Delete/Revert CU
                ...
                jQuery(document).on( "click", "#deleteConfirmCU", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ppt-workshop.report.deleteCU') }}",
                        method:"POST",
            ...
            // Filter by Brand Workshop Unit
                $('input[name="RadioBrand"]').change(function() {
                    ...
                    $.ajax({
                        url: "{{ route('ppt-workshop.report.sortBrand') }}",
                        type: "GET",
            ...
            // Filter by Status Pullout Unit
                $('input[name="pou-radio-unit"]').change(function() {
                    ...
                    $.ajax({
                        url: "{{ route('ppt-workshop.report.sortPullOut') }}",
                        type: "GET",
            ...
            // Filter by Status Confirm Unit
                $('input[name="cuRadioStatus"]').change(function() {
                    ...
                    $.ajax({
                        url: "{{ route('ppt-workshop.report.sortConfirm') }}",
                        type: "GET",
                        data: {unitStatus: unitStatus, _token: _token},
                        success: function(result) {
                            $('#tableBCU').html(result);
    ...
    // BRAND NEW UNIT
            ...
            // Saving of Brand New
                ...
                $('#saveNewUnitH').on( "click", function(){
                    $.ajax({
                        url: "{{ route('ppt-workshop.report.saveBrandNew') }}",
                        type: "POST",
            ...
            // View Brand New
                jQuery(document).on( "click", ".btnBNUView", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ppt-workshop.report.getBNUData') }}",
                        method:"GET",
                        dataType: 'json',
                        data:{id: id, utype: utype, _token: _token,},
                        success:function(result){
            ...
            // Delete Brand New
                ...
                jQuery(document).on( "click", "#deleteConfirmBNU", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ppt-workshop.report.deleteBNU') }}",
                        method:"POST",
                        data:{id: id, unittype: unittype, _token: _token,},
                        success:function(result){
                            $("#btnSuccessH").click();
            ...
            // Transfer Brand New
                jQuery(document).on( "click", "#transferBNU", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ppt-workshop.report.transferNewUnit') }}",
                        method:"POST",
                        data: $("#formBNUT").serialize(),
                        success:function(result){
                            $("#transferBNU").prop("disabled", false);
                            $('#tableBNewUnit').html(result);
                            $("#btnSuccessH").click();
    ...
    // REPORT
        // If Area Change, Data from Bay also changes
            jQuery(document).on( "change", "#RBayArea", function(){
                ...
                $.ajax({
                    url:"{{ route('ppt-workshop.report.getBayR') }}",
                    method:"GET",
                    data:{area: area, _token: _token,},
                    success:function(result){
                        $('#RBayNum').html(result);
        ...
        // Brand Report
            jQuery(document).on( "click", "#RGenBrand", function(){
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.generateBrandReport') }}",
                    method: 'POST',
                    data: {
                        UBrand: UBrand,
                        fromDate: fromDate,
        ...
        // Bay Report
            jQuery(document).on("click", "#RGenBay", function() {RBayName
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.generateBayReport') }}",
                    method: 'POST',
                    data: {
                        bayName: bayName,
                        bayNum: bayNum,
        ...
        // Search
            jQuery(document).on( "click", "#RPUSearch", function(){
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.searchRPU') }}",
                    method: 'POST',
                    data: {
                        CatSearch: CatSearch,
        ...
        // Unit Report
            jQuery(document).on("click", ".btnPrint", function() {
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.generateUnitReport') }}",
                    method: 'POST',
                    data: {
                        id: id,
                        _token: _token
        ...
        // Unit Report
            jQuery(document).on("click", ".btnPrintAll", function() {
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.generateUnitRecord') }}",
                    method: 'POST',
                    data: {
                        snum: snum,
                        _token: _token
        ...
        // Pull Out Unit Report
            jQuery(document).on("click", "#RGenPOU", function() {
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.generatePOUReport') }}",
                    method: 'POST',
                    data: {
                        fromDate: fromDate,
                        toDate: toDate,
        ...
        // Delivered Unit Report
            jQuery(document).on("click", "#RGenDU", function() {
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.generateDUReport') }}",
                    method: 'POST',
                    data: {
                        fromDate: fromDate,
                        toDate: toDate,
        ...
        // Cannibalized Unit Report
            jQuery(document).on("click", "#RGenCanUnit", function() {
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.generateCanUnitReport') }}",
                    method: 'POST',
                    data: {
                        fromDate: fromDate,
                        toDate: toDate,
        ...
        // DR Monitoring Report
            jQuery(document).on("click", "#RGenDRMon", function() {
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.generateDRMonReport') }}",
                    method: 'POST',
                    data: {
                        fromDate: fromDate,
                        toDate: toDate,
    ...
    // Cannibalized Unit
        // Change Table Data Depending on Radio Button(ALL, Pending, Closed, NFR)
            $('input[name=RadioCanUnit]').on( "change", function(){
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.getCanUnitStatus') }}",
                    type: "GET",
                    data: {id:id,},
                    success: function(result) {
                        console.log(result)
        ...
        // Saving of Cannibalized Unit
            $('#saveCanUnit').on( "click", function(){
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.saveCanUnit') }}",
                    type: "POST",
        ...
        // Edit Cannibalized Unit
            jQuery(document).on( "click", ".btnCanUnitEdit", function(){
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.getCanParts') }}",
                    type: "POST",
                    dataType: "JSON",
        ...
        // Delete Cannibalized Unit
            ...
            jQuery(document).on( "click", "#deleteConfirmCanUnit", function(){
                ...
                $.ajax({
                    url:"{{ route('ppt-workshop.report.deleteCanUnit') }}",
                    method: "POST",
    ...
    // DR Monitoring
        // Change Table Data Depending on Radio Button(ALL, Pending, Closed, NFR)
            $('input[name=RadioDRMon]').on( "change", function(){
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.getDRMonStatus') }}",
                    type: "GET",
                    data: {id:id,},
                    success: function(result) {
                        console.log(result)
        ...
        // Saving of DR Monitoring
            $('#saveDRMon').on( "click", function(){
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.saveDRMon') }}",
                    type: "POST",
        ...
        // Edit DR Monitoring
            jQuery(document).on( "click", ".btnDRMonEdit", function(){
                ...
                $.ajax({
                    url: "{{ route('ppt-workshop.report.getDRParts') }}",
                    type: "POST",
        ...
        // Delete D.R. Monitoring
            ...
            jQuery(document).on( "click", "#deleteConfirmDRMon", function(){
                ...
                $.ajax({
                    url:"{{ route('ppt-workshop.report.deleteDRMon') }}",
                    method: "POST",
