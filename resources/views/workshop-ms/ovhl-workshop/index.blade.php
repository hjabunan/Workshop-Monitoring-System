        ...
        $(document).ready(function(){
            ...
            // Get Data per Bay
                jQuery(document).on( "click", ".btnBay", function(){
                    ...
                    $.ajax({
                        url: "{{ route('ovhl-workshop.getBayData') }}",
                        type: "GET",
                        dataType: "json",
            ...
            // Save Other Data of Unit
                jQuery(document).on( "click", "#saveBayMon", function(){
                    $.ajax({
                        url: "{{ route('ovhl-workshop.saveBayData') }}",
                        type: "POST",
                        dataType: "JSON",
            ...
            // Save Downtime
                jQuery(document).on( "click", "#saveDT", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ovhl-workshop.saveDowntime') }}",
                        method: "POST",
            ...
            // Get details of Downtime
                jQuery(document).on( "click", "#DTTable tr", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ovhl-workshop.getDowntime') }}",
                        method:"POST",
                        dataType: 'json',
            ...
            // Delete Downtime
                jQuery(document).on( "click", "#deleteDT", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ovhl-workshop.deleteDowntime') }}",
                        method: "POST",
                        dataType: 'json',
            ...
            // Save Parts Information
                jQuery(document).on( "click", "#savePI", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ovhl-workshop.savePI') }}",
                        method: "POST",
                        dataType: 'json',
            ...
            // Delete Parts
                ...
                jQuery(document).on( "click", "#deleteConfirmParts", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ovhl-workshop.deletePI') }}",
                        method:"POST",
                        dataType: 'json',
            ...
            // For Delete and Revert of Installed Parts
                ...
                jQuery(document).on( "click", "#btnRevertPI", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ovhl-workshop.revertParts') }}",
                        method:"POST",
                        dataType: 'json',
                ...
                jQuery(document).on( "click", "#btnDeletePI", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ovhl-workshop.deleteIParts') }}",
                        method:"POST",
                        dataType: 'json',
                        data:{id: id, JONum: JONum, _token: _token,},
                        success:function(result){
            ...
            // View Technician Schedule
                jQuery(document).on( "click", "#viewSchedule", function(){
                    ...
                    $.ajax({
                        url: "{{ route('ovhl-workshop.viewSchedule') }}",
                        type: "POST",
                        dataType: "JSON",
            ...
            // Save Technician Activity
                jQuery(document).on( "click", "#saveActivity", function(){
                    ...
                    $.ajax({
                        url: "{{ route('ovhl-workshop.saveActivity') }}",
                        type: "POST",
                        dataType: "JSON",
            ...
            // Save Remarks
                jQuery(document).on( "click", "#updateRemarks", function(){
                    ...
                    $.ajax({
                        url: "{{ route('ovhl-workshop.saveRemarks') }}",
                        type: "POST",
            ...
            // If Area Change, Data from Bay also changes
                jQuery(document).on( "change", "#UnitArea", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ovhl-workshop.report.getBay') }}",
                        method:"GET",
            ...
            // Get Data of Transfer Unit
                jQuery(document).on( "click", "#transferUnit", function(){
                    ...
                    $.ajax({
                        url: "{{ route('ovhl-workshop.getTransferData') }}",
                        type: "GET",
                        dataType: "JSON",
            ...
            // Parts Search
                ...
                jQuery(document).on( "keyup", ".inputOption", function(e){
                    ...
                    if (length = 3){
                        $.ajax({
                            url:"{{ route('ovhl-workshop.search') }}",
                            method:"GET",
                            dataType: 'json',
                            data:{
                                value: value,
                ...
                jQuery(document).on( "click", ".listOption li", function(){
                    ...
                    $.ajax({
                        url:"{{ route('ovhl-workshop.getPartsInfox') }}",
                        method:"POST",
                        dataType: 'json',
                        data:{
                            id: partid,
