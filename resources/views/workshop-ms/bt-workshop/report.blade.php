...
<x-app-layout>
    ...
    {{-- MODALS --}}
        ...
        <div id="modalPOU" data-modal-backdrop="static" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        ...
        $(document).ready(function () {
            ...
            // Filter by Status Confirm Unit
                $('input[name="cuRadioStatus"]').change(function() {
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.sortConfirm') }}",
                        type: "GET",
                        data: {unitStatus: unitStatus, _token: _token},
                        success: function(result) {
                            $('#tableBCU').html(result);
    ...
    // BRAND NEW UNIT
            ...
            // Transfer POU
                jQuery(document).on( "click", "#transferBNU", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.report.transferNewUnit') }}",
                        method:"POST",
    ...
    // DELIVERED UNIT
            ...
            // Delete/Revert DU
                ...
                jQuery(document).on( "click", "#deleteConfirmDU", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.report.deleteDU') }}",
                        method:"POST",
    ...
    // REPORT
            // If Area Change, Data from Bay also changes
                jQuery(document).on( "change", "#RBayArea", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.report.getBayR') }}",
                        method:"GET",
                        data:{area: area, _token: _token,},
                        success:function(result){
                            $('#RBayNum').html(result);
            ...
            // Brand Report
                jQuery(document).on( "click", "#RGenBrand", function(){
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.generateBrandReport') }}",
                        method: 'POST',
                        data: {
                            UBrand: UBrand,
                            fromDate: fromDate,
            ...
            // Bay Report
                jQuery(document).on("click", "#RGenBay", function() {RBayName
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.generateBayReport') }}",
                        method: 'POST',
                        data: {
                            bayName: bayName,
                            bayNum: bayNum,
            ...
            // Search
                jQuery(document).on( "click", "#RPUSearch", function(){
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.searchRPU') }}",
                        method: 'POST',
                        data: {
                            CatSearch: CatSearch,
            ...
            // Unit Report
                jQuery(document).on("click", ".btnPrint", function() {
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.generateUnitReport') }}",
                        method: 'POST',
                        data: {
                            id: id,
                            _token: _token
            ...
            // Unit Report
                jQuery(document).on("click", ".btnPrintAll", function() {
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.generateUnitRecord') }}",
                        method: 'POST',
                        data: {
                            snum: snum,
                            _token: _token
            ...
            // Pull Out Unit Report
                jQuery(document).on("click", "#RGenPOU", function() {
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.generatePOUReport') }}",
                        method: 'POST',
                        data: {
                            fromDate: fromDate,
                            toDate: toDate,
            ...
            // Delivered Unit Report
                jQuery(document).on("click", "#RGenDU", function() {
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.generateDUReport') }}",
                        method: 'POST',
                        data: {
                            fromDate: fromDate,
                            toDate: toDate,
            ...
            // Cannibalized Unit Report
                jQuery(document).on("click", "#RGenCanUnit", function() {
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.generateCanUnitReport') }}",
                        method: 'POST',
                        data: {
                            fromDate: fromDate,
                            toDate: toDate,
            ...
            // DR Monitoring Report
                jQuery(document).on("click", "#RGenDRMon", function() {
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.report.generateDRMonReport') }}",
                        method: 'POST',
                        data: {
                            fromDate: fromDate,
                            toDate: toDate,
    ...
    // Cannibalized Unit
            ...
            // Edit Cannibalized Unit
                jQuery(document).on( "click", ".btnCanUnitEdit", function(){
                    ...
                    $.ajax({
                        url: "{{ route('r-workshop.report.getCanParts') }}",
                        type: "POST",
                        dataType: "JSON",
            ...
            // Delete Cannibalized Unit
                ...
                jQuery(document).on( "click", "#deleteConfirmCanUnit", function(){
                    ...
                    $.ajax({
                        url:"{{ route('r-workshop.report.deleteCanUnit') }}",
                        method: "POST",
