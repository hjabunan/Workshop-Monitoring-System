                                ...
                                <div class="grid grid-cols-4 content-start gap-2 mr-2">
                                    @foreach ($bays as $bay)
                                        @if ($bay->section == 2)
                                                ...
                                                @foreach ($workshop as $WS)
                                                    @if ($WS->WSBayNum == $bay->id)
                                                        {{-- CLASS AND STATUS --}}
                                                            ...
                                                            @endphp
                                                        <div class="">
                                                            <div data-modal-target="modalUnitInfo" data-modal-toggle="modalUnitInfo" data-id="{{$bay->id}}" data-bayname="{{$bay->area_name}}" class="btnBay {{$color}} block focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full" style="cursor: pointer;">
                                            ...
                                            @else
                                                <div class="">
                                                    <div data-modal-target="modalUnitInfo" data-modal-toggle="modalUnitInfo" data-id="{{$bay->id}}" data-bayname="{{$bay->area_name}}" class="btnBay bg-gray-500 block focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full" style="cursor: pointer;">
                                                        <div class=""><label class="font-medium text-lg">{{$bay->area_name}}</label></div>
                                ...
                                <div class="col-span-6 flex flex-col h-full gap-y-4">
                                    ...
                                    <div class="h-1/2">
                                        ...
                                        <div class="grid grid-cols-7">
                                            <div class="col-span-5 overflow-y-auto" style="height: calc(100vh - 550px);">
                                            ...
                                            <div class="col-span-2 bg-green-200 p-2" style="height: calc(100vh - 550px);">
                                                <div class="grid grid-cols-2">
                                                    <div class="">
        ...
        $(document).ready(function(){
            ...
            // Get Data per Bay
                jQuery(document).on( "click", ".btnBay", function(){
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.getBayData') }}",
                        type: "GET",
                        dataType: "json",
            ...
            // Save Other Data of Unit
                jQuery(document).on( "click", "#saveBayMon", function(){
                    $.ajax({
                        url: "{{ route('bt-workshop.saveBayData') }}",
                        type: "POST",
                        dataType: "JSON",
            ...
            // Save Dates on Target
                jQuery(document).on( "click", "#TUpdate", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.saveTargetActivity') }}",
                        method: "POST",
            ...
            // Save Date of Inspection Start
                jQuery(document).on( "click", "#updateIDS", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.updateIDS') }}",
                        method: "POST",
            ...
            // Save Date of Inspection End
                jQuery(document).on( "click", "#updateIDE", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.updateIDE') }}",
                        method: "POST",
            ...
            // Save Date of Repair Start
                jQuery(document).on( "click", "#updateRDS", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.updateRDS') }}",
                        method: "POST",
            ...
            // Save Date of Repair End
                jQuery(document).on( "click", "#updateRDE", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.updateRDE') }}",
                        method: "POST",
            ...
            // Reset Dates on Actual
                jQuery(document).on( "click", "#AReset", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.resetActual') }}",
                        method: "POST",
            ...
            // Save Downtime
                jQuery(document).on( "click", "#saveDT", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.saveDowntime') }}",
                        method: "POST",
            ...
            // Get details of Downtime
                jQuery(document).on( "click", "#DTTable tr", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.getDowntime') }}",
                        method:"POST",
                        dataType: 'json',
            ...
            // Delete Downtime
                jQuery(document).on( "click", "#deleteDT", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.deleteDowntime') }}",
                        method: "POST",
                        dataType: 'json',
            ...
            // Get details of Parts
                jQuery(document).on( "click", "#PParts tr", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.getPInfo') }}",
                        method:"POST",
                        dataType: 'json',
            ...
            // Delete Parts
                ...
                jQuery(document).on( "click", "#deleteConfirmParts", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.deletePI') }}",
                        method:"POST",
                        dataType: 'json',
            ...
            // For Delete and Revert of Installed Parts
                ...
                jQuery(document).on( "click", "#btnRevertPI", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.revertParts') }}",
                        method:"POST",
                        dataType: 'json',
                ...
                jQuery(document).on( "click", "#btnDeletePI", function(){
                    ...
                    $.ajax({
                        url:"{{ route('bt-workshop.deleteIParts') }}",
                        method:"POST",
                        dataType: 'json',
                        data:{id: id, JONum: JONum, _token: _token,},
                        success:function(result){
            ...
            // View Technician Schedule
                jQuery(document).on( "click", "#viewSchedule", function(){
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.viewSchedule') }}",
                        type: "POST",
                        dataType: "JSON",
            ...
            // Save Technician Activity
                jQuery(document).on( "click", "#saveActivity", function(){
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.saveActivity') }}",
                        type: "POST",
                        dataType: "JSON",
            ...
            // Save Remarks
                jQuery(document).on( "click", "#updateRemarks", function(){
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.saveRemarks') }}",
                        type: "POST",
            ...
            // Get Data of Transfer Unit
                jQuery(document).on( "click", "#transferUnit", function(){
                    ...
                    $.ajax({
                        url: "{{ route('bt-workshop.getTransferData') }}",
                        type: "GET",
                        dataType: "JSON",
