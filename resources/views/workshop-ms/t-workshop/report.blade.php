                            ...
                            <div class="grid grid-cols-5 items-center">
                                ...
                                <div id="input" class="col-span-2 uppercase mt-5">
                                    <select name="BNUStatus" id="BNUStatus" class="block w-full p-1.5 text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-center uppercase">
                                        ...
                                        <option value="12">RESERVED UNIT</option>
                                        <option value="13">WAITING FOR MCI</option>
                                        <option value="14">WAITING FOR PDI</option>
                                        <option value="15">DONE PDI (WFD)</option>
                                    </select>
                                </div>
                                <div id="input" class="col-span-2">
                                </div>
        ...
        $(document).ready(function () {
            ...
            // Filter by Status Confirm Unit
                $('input[name="cuRadioStatus"]').change(function() {
                    ...
                    $.ajax({
                        url: "{{ route('t-workshop.report.sortConfirm') }}",
                        type: "GET",
                        data: {unitStatus: unitStatus, _token: _token},
                        success: function(result) {
                            $('#tableBCU').html(result);
        ...
        // DELIVERED UNIT
            ...
            // Delete/Revert DU
                ...
                jQuery(document).on( "click", "#deleteConfirmDU", function(){
                    ...
                    $.ajax({
                        url:"{{ route('t-workshop.report.deleteDU') }}",
                        method:"POST",
