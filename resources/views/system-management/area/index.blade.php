                        ...
                        <div class="flex items-center mt-1 justify-self-end">
                            <div id="searchContainer" class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="search" id="ATableSearch" value="{{$search}}" class="block w-96 p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search Parts, Part Number..." required>
