                ...
                <div class="p-3 text-gray-900 h-full">
                    ...
                    {{-- Start Add --}}
                        <div class="bg-white p-4 mt-4 relative overflow-x-auto shadow-md sm:rounded-lg">
                            <form action="{{route('scl.store')}}" method="POST" class="px-60 ">
                                @csrf
                                <div class="grid grid-flow-row-dense grid-cols-2 gap-x-5">
                                    <div class="mb-6 col-span-1">
                                        ...
                                        <input type="text" id="stg_name" name="stg_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" uppercase required>
                                    </div>
                                    <div class="mb-6 col-span-1">
                                    ...
                                    <div class="mb-6 col-span-1">
                                        ...
                                        <input type="text" id="din" name="din" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" uppercase required>
                                    </div>
                                    <div class="mb-6 col-span-1">
                                        <label for="dout" class="block mb-2 text-sm font-medium text-gray-900">Day Out</label>
                                        <input type="text" id="dout" name="dout" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" uppercase required>
                                    </div>
                                </div>
                                ...
                                <a href="{{route('scl.index')}}" type="button" class="text-white bg-gray-500 hover:bg-neutral-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">CANCEL</a>
                            </form>
                        </div>
                    {{-- End Add --}}
