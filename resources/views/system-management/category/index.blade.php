                ...
                <div class="p-3 text-gray-900 h-full">
                    <div class="px-4 grid grid-cols-2 gap-x-3 ">
                        ...
                        <div class="self-center justify-self-end">
                            <a id="btn-add" href="{{route('category.create')}}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-16 py-2.5 text-center">ADD CATEGORY</a>
                        </div>
                    </div>
                            ...
                            <table id="tdept" class="w-full h-full text-sm text-left text-gray-500 row-border stripe">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b ">
                                        ...
                                        <td class="px-6 py-4">
                                            <a href="{{ url('/system-management/category/edit/'.$cat->id ) }}" class="font-medium text-blue-600  hover:underline ">Edit</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
