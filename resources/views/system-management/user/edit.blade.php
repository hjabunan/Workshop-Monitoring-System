                            ...
                            <form action="{{ url('/system-management/user/update/'.$users->id ) }}" method="POST" class="px-60 ">
                                ...
                                <div class="grid grid-flow-row-dense grid-cols-2 gap-x-5">
                                    ...
                                    <div class="mb-6 col-span-1">
                                        ...
                                        <input type="text" id="area" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  value="{{$users->area}}">
                                    </div>
