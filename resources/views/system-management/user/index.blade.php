            ...
            <div class="overflow-hidden sm:rounded-lg h-full">
                <div class="p-3 text-gray-900 h-full">
                    <div class="px-4 grid grid-cols-2 gap-x-3 ">
                        ...
                        <div class="col-span-2 self-center justify-self-end mt-1 !w-[100px]">
                            <div class="relative">
                                ...
                                <input type="search" id="searchUser" class="block !w-[80px] p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search User..." required>
                            </div>
                        </div>
                    </div>
