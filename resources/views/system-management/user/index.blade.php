        ...
        <div class="max-w-7xl mx-auto sm:px-3 lg:px-5 h-full">
            <div class="overflow-hidden sm:rounded-lg h-full">
                <div class="p-3 text-gray-900 h-full">
                    ...
                    <div class="px-4 grid grid-cols-4 gap-x-3 ">
                        <div class="col-span-3 mt-1"></div>
                        <div class="self-center mt-1"> <!-- This div is added to push the search bar to the right -->
                            <div class="relative">
                                ...
                                <input type="search" id="searchUser" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search User..." required>
                            </div>
                        </div>
                    </div>
